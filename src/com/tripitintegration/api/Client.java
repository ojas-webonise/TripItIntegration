...
package com.tripitintegration.api;

import com.tripitintegration.auth.*;
...
public class Client {
    ...
    public static final String DEFAULT_WEB_URI_PREFIX = "https://m.tripit.com";
    ...
    private Request genRequest(Action a, Type t, Map<String, String> requestParameterMap) throws Exception {
        ...
        System.out.println(" Client->genRequest()->URL == "+url);
